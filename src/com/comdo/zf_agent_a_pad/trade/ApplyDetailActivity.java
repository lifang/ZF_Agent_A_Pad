...
import static com.comdo.zf_agent_a_pad.fragment.Constants.ApplyIntent.REQUEST_CHOOSE_BANK;
...
import static com.comdo.zf_agent_a_pad.fragment.Constants.ApplyIntent.REQUEST_TAKE_PHOTO;
import static com.comdo.zf_agent_a_pad.fragment.Constants.ApplyIntent.REQUEST_UPLOAD_IMAGE;
...
import com.comdo.zf_agent_a_pad.trade.entity.MyApplyCustomerDetail;
		...
		Config.getApplyDetail(this, mTerminalId, mTerminalStatus,
				new HttpCallback<My_ApplyDetail>(this) {
					...
					public void onFailure(String message) {
						...
						CommonUtil
								.toastShort(ApplyDetailActivity.this, message);
						finish();
					}
