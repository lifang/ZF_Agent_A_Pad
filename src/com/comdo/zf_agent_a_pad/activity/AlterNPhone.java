...
public class AlterNPhone extends Activity implements OnClickListener {
	...
	void getncode(String phone) {
		...
		if (!StringUtil.isNull(ed_phone.getText().toString())) {
			...
			Config.getPhoneNCode(AlterNPhone.this, ed_phone.getText().toString(),MyApplication.NewUser.getAgentUserId(),ed_code.getText().toString(),
					
					new HttpCallback(AlterNPhone.this) {
						@Override
						public void onSuccess(Object data) {
							AlterNPhone.this.finish();
							//Log.i("cc",data.getPhone());
							 Toast.makeText(getApplicationContext(),"修改手机号成功！",
							 1000).show();
						}
	...
	void getcode(String phone) {
		...
		if (!StringUtil.isNull(phone)) {
			Config.getPhoneCode(AlterNPhone.this, phone,
					MyApplication.NewUser.getAgentUserId(),
					new HttpCallback<AlterPhoneentity>(AlterNPhone.this) {
						@Override
