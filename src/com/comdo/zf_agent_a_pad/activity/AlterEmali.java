...
public class AlterEmali extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new TitleMenuUtil(AlterEmali.this, "修改邮箱").show();
		initView();
	...
	void getcode(String phone) {
		...
		if (!StringUtil.isNull(phone)) {
			Config.getEmailCode(AlterEmali.this, phone,
					MyApplication.NewUser.getAgentUserId(),
					new HttpCallback<AlterPhoneentity>(AlterEmali.this) {
						@Override
