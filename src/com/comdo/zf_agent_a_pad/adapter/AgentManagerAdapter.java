...
public class AgentManagerAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holdel.tv_agent_type = (TextView) convertView
					.findViewById(R.id.tv_agent_type);
			holdel.tv_agent_name = (TextView) convertView
					.findViewById(R.id.tv_agent_name);
			holdel.tv_join_time = (TextView) convertView
		...
		holdel.tv_agent_name.setText(dataadagent.get(position)
				.getCompany_name());
